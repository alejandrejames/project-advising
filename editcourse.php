                    ...
                    <?php
                                  ...
                                  echo '
                                    ...
                                    for($i=0;$i<$numpages;$i++){
                                        if($i==0)
                                            echo '<li class="active" id="page-'.$i.'"><a href="#" onclick="pagina('.$i.',4,0,'.$pagenum.')">'.($i+1).'</a></li>';
                                        else
                                            echo '<li class="" id="page-'.$i.'"><a href="#" onclick="pagina('.$i.',4,'.$pagenum.','.($pagenum = $pagenum+$pagenum).')">'.($i+1).'</a></li>';
                                    }
                                  echo '
                                        </ul>
                                      </nav>
